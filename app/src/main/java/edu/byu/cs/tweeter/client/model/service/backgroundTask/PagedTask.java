...
public abstract class PagedTask<T> extends AuthenticatedTask{
    ...
    protected abstract PagedResponse getResponse() throws IOException, TweeterRemoteException;

    protected PagedTask(AuthToken authToken, User targetUser, int limit, T lastItem,
