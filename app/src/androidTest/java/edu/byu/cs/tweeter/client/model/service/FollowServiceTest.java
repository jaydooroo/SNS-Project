...
public class FollowServiceTest {
    ...
    /**
     * Verify that for successful requests, the {@link FollowService#loadMoreFollowingItems}
    ...
    public void testGetFollowees_validRequest_correctResponse() throws InterruptedException {
        followServiceSpy.loadMoreFollowingItems(currentAuthToken, currentUser, 3, null, (PagedObserver<User>) observer);
        awaitCountDownLatch();
    ...
    /**
     * Verify that for successful requests, the the {@link FollowService#loadMoreFollowingItems}
    ...
    public void testGetFollowees_validRequest_loadsProfileImages() throws InterruptedException {
        followServiceSpy.loadMoreFollowingItems(currentAuthToken, currentUser, 3, null, observer);
        awaitCountDownLatch();
    ...
    /**
     * Verify that for unsuccessful requests, the the {@link FollowService#loadMoreFollowingItems}
    ...
    public void testGetFollowees_invalidRequest_returnsNoFollowees() throws InterruptedException {
        followServiceSpy.loadMoreFollowingItems(null, null, 0, null, observer);
        awaitCountDownLatch();
